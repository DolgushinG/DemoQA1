...
@pytest.mark.parametrize('name1, name2', [("First1", "First2"),
                                          ("Svetka", "Ivanova"),
                                          ("Tommy", "Lee")])
def test_form2(browser, name1, name2):
    ...
    practice_form_page = PracticeFormPage(browser)
    practice_form_page.fill_in_fist_name(name1)
    practice_form_page.fill_in_last_name(name2)
    time.sleep(3)
    practice_form_page.take_screenshot()
